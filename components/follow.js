...
const IntroSection = () => {
  return (
    <section className="intro-section py-10 bg-black">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="md:w-1/2 px-10 md:px-20">
          <p className="text-2xl mb-6 text-white">FOLLOW TALI$A KIDD ON FACEBOOK, TWITTER, INSTAGRAM, TIKTOK AND YOUTUBE</p>
          ...
          <form>
            <div className="flex flex-col md:flex-row items-center mb-6">
              ...
              <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" type="button">JOIN THE TALI$A KIDD MAILING LIST</button>
            </div>
